...
class UpdateJuezRequest extends FormRequest
{
    ...
    {
        return [
            'IdJuez' => 'required|integer', // Asegúrate de que exista en la tabla eventos
    ...
    {
        return [
            'IdJuez.required' => 'El campo IdJuez es obligatorio.',
            'IdJuez.integer' => 'El campo IdJuez debe ser un número entero.',
