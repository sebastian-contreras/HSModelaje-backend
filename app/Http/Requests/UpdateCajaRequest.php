...
class UpdateCajaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'Tamaño' => 'nullable|string|max:20', // Tamaño con un máximo de 20 caracteres
            'Ubicacion' => 'nullable|string|max:250', // Ubicación con un máximo de 250 caracteres
            'Fila' => 'nullable|string|max:10', // Fila con un máximo de 10 caracteres
            'Columna' => 'nullable|string|max:10', // Columna con un máximo de 10 caracteres
