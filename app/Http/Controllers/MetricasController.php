...
class MetricasController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            $lista = $this->gestorMetricas->ListarEnEvento($pIdEvento, $pIncluyeBajas);
    ...
    public function busqueda(Request $request)
    {
        ...
        try {
            $lista = $this->gestorMetricas->BuscarEnEvento($pOffset, $pCantidad, $pIdEvento, $pMetrica, $pIncluyeInactivos);  
